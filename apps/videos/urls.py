...
urlpatterns = [
    ...
    path("<int:video_id>/status/", views.video_status, name="status"),
    path("<int:video_id>/delete/", views.video_delete, name="delete"),
    path("<int:video_id>/budget/approve/", views.budget_approve, name="budget_approve"),
    path("<int:video_id>/budget/revoke/", views.budget_revoke, name="budget_revoke"),
    path("<int:video_id>/batch-approve/", views.step_batch_approve, name="batch_approve"),
    path("<int:video_id>/parts/<int:chapter_id>/approve/", views.part_approve, name="part_approve"),
